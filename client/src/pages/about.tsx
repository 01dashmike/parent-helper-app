          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-teal-dark mb-6">
                The endless searching for baby classes in our area, toddler activities locally, and family-friendly events had become a time-consuming chore. We'd waste precious family time hunting down information that was scattered across dozens of different council websites, local Facebook groups, and community pages.
              </p>
